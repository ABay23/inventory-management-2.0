      ...
      <section class='text-gray-400 body-font bg-white'>
        <div class='container px-5 py-24 mx-auto'>
          <div class='flex flex-wrap w-full mb-20 flex-col items-center text-center'>
            ...
            <p class='lg:w-2/3 w-full leading-relaxed text-opacity-80 text-3xl text-cyan-700'>
          ...
          <div class='flex flex-wrap -m-4'>
            <div class='xl:w-1/3 md:w-1/2 p-4'>
              <div class='border border-gray-700 border-opacity-75 p-6 rounded-lg'>
                <div class='w-10 h-10 inline-flex items-center justify-center rounded-full bg-gray-800 text-blue-400 mb-4'>
                  <svg
                    fill='none'
                    stroke='currentColor'
            ...
            <div class='xl:w-1/3 md:w-1/2 p-4'>
              <div class='border border-gray-700 border-opacity-75 p-6 rounded-lg'>
                <div class='w-10 h-10 inline-flex items-center justify-center rounded-full bg-blue-100 text-blue-400 mb-4'>
                  <svg
                    fill='none'
                    stroke='currentColor'
                    stroke-linecap='round'
                ...
                <h2 class='text-lg text-black font-medium title-font mb-2'>
                  Bunker
                </h2>
                <p class='leading-relaxed text-base'>
                  Fingerstache flexitarian street art 8-bit waist co, subway
