      ...
      <section className='text-gray-400 body-font bg-white'>
        <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-wrap w-full mb-20 flex-col items-center text-center'>
            ...
            <p className='lg:w-2/3 w-full leading-relaxed text-opacity-80 text-3xl text-cyan-700'>
          ...
          <div className='flex flex-wrap -m-4'>
            ...
            <div className='xl:w-1/3 md:w-1/2 p-4'>
              <div className='border border-gray-700 border-opacity-75 p-6 rounded-lg'>
                <div className='w-10 h-10 inline-flex items-center justify-center rounded-full bg-blue-100 text-blue-400 mb-4'>
                  <svg
                    fill='none'
                    stroke='currentColor'
                    strokeLinecap='round'
