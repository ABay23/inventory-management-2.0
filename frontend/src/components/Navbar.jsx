            ...
            {isLoggedIn ? (
              <>
                <div className=' flex flex-row'>
                  <div className=' px-4 py-2 align-middle text-cyan-300'>{`Welcome ${name}`}</div>
                  <div className='flex justify-center'>
                    <button
                      className='inline-flex items-center bg-blue-700 border-0 py-2 px-8 min-w-30 md:w-auto focus:outline-none hover:bg-gray-700 rounded text-base mt-4 md:mt-0 text-gray-200 '
                      onClick={logout}
                    >
                      Logout
                    </button>
